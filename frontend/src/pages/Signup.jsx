  ...
  return (
    <div className="flex items-center justify-center min-h-[80vh]">
      <div className="bg-slate-800/50 backdrop-blur-md border border-slate-700/50 rounded-2xl p-8 shadow-xl w-full max-w-md">
        <h2 className="text-3xl font-extrabold text-white tracking-tight mb-6 text-center">Create Account</h2>
        ...
        <p className="mt-6 text-center text-slate-400 text-sm">
          Already have an account? <Link to="/login" className="text-purple-400 font-semibold hover:text-purple-300">Login</Link>
        </p>
      </div>
    </div>
  );
